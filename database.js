    ...
    async saveRegisteredOrder(orderData, msgMetadata = {}) {
        const { data, error } = await supabase
            ...
            .insert([{
                ...
                city_municipality: orderData.Ciudad_Municipio || orderData["Ciudad/Municipio"],
                state: orderData.Estado,
                zip_code: orderData.CP || null,
                cross_streets: orderData.Entre_calles || orderData["Entre calles"] || null,
                ...
                is_duplicate: !!msgMetadata.is_duplicate,
                duplicate_of: msgMetadata.duplicate_of || null,
